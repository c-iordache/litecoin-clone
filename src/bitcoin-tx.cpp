...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s barcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  barcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded barcoin transaction") + "\n" +
              "  barcoin-tx [options] -create [commands]   " + _("Create hex-encoded barcoin transaction") + "\n" +
              "\n";

...
const char * const BITCOIN_CONF_FILENAME = "barcoin.conf";
const char * const BITCOIN_PID_FILENAME = "barcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Barcoin";
#else
    // Unix

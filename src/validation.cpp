...
#if defined(NDEBUG)
# error "Barcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Barcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BAR additional fees, %d delta bytes\n",

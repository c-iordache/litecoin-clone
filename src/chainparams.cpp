...
{
    const char* pszTimestamp = "3 Jan 2018 North Korea reopens hotline to South to discuss Olympics";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1514988484, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("dnsseed.barcointools.com", true);
        vSeeds.emplace_back("dnsseed.barcoinpool.org", true);

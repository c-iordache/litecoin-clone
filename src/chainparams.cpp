...
{
    const char* pszTimestamp = "Trump has no credibility - Fire and Fury author Michael Wolff";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1515157990, 249187, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7dc50415ff29b98895015007709e031d50c640a703583550a8204d00ee185f4f"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f25cd7b4a82fec0295264cc54ff13649367e7bd350dd4fc4e1f9032dde5a34f"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.barcoin.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("159.89.24.117", true);
        vSeeds.emplace_back("83.194.255.9", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 0, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.barcointools.com", true);
        vSeeds.emplace_back("seed-b.barcoin.loshan.co.uk", true);
